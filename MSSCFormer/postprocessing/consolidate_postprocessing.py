...
def collect_cv_niftis(cv_folder: str, output_folder: str, validation_folder_name: str = 'validation_raw',
    ...
    # validation_raw_folders = [join(cv_folder, "fold_0", validation_folder_name)]
...
if __name__ == "__main__":
    ...
    folder = args.f
    # output_folder_base = "G:/CY/CodesOfCy/new/MSSCFormer-main/DATASET/MSSCFormer_trained_models/MSSCFormer/3d_fullres/Task001_ACDC/MSSCFormerTrainerV2_MSSCFormer_acdc__MSSCFormerPlansv2.1"
    # output_folder_gt = "G:/CY/CodesOfCy/new/MSSCFormer-main/DATASET/MSSCFormer_raw/MSSCFormer_raw_data/Task01_ACDC/labelsTs"
    # determine_postprocessing(output_folder_base, output_folder_gt, 'cv_niftis_raw',
    #                          final_subf_name="cv_niftis_postprocessed", processes=1,
