...
import argparse
from MSSCFormer.postprocessing.consolidate_postprocessing import consolidate_folds
...
def main():
    ...
    argparser.add_argument("-tr", type=str, required=False, default=None,
                           help="MSSCFormerTrainer class. Default: %s, unless 3d_cascade_fullres "
    ...
    if trainer is None:
        if model == "3d_cascade_fullres":
            trainer = "MSSCFormerTrainerV2CascadeFullRes"
        else:
            trainer = "MSSCFormerTrainerV2"
