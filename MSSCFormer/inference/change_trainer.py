...
def pretend_to_be_MSSCFormerTrainer(folder, checkpoints=("model_final_checkpoint.pkl", "model_final_checkpoint.model.pkl")):
    pretend_to_be_other_trainer(folder, "MSSCFormerTrainer", checkpoints)


def pretend_to_be_other_trainer(folder, new_trainer_name, checkpoints=("model_final_checkpoint.pkl", "model_final_checkpoint.model.pkl")):
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description='Use this script to change the MSSCFormer trainer class of a saved '
