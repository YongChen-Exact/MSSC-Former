...
from MSSCFormer.training.network_training.MSSCFormerTrainerV2 import MSSCFormerTrainerV2
...
class MSSCFormerTrainerV2CascadeFullRes(MSSCFormerTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="MSSCFormerTrainerV2", fp16=False):
