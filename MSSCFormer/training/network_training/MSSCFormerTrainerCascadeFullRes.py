...
import matplotlib
from MSSCFormer.postprocessing.connected_components import determine_postprocessing
from MSSCFormer.training.data_augmentation.default_data_augmentation import get_default_augmentation
from MSSCFormer.training.dataloading.dataset_loading import DataLoader3D, unpack_dataset
from MSSCFormer.evaluation.evaluator import aggregate_scores
...
from MSSCFormer.inference.segmentation_export import save_segmentation_nifti_from_softmax
from batchgenerators.utilities.file_and_folder_operations import *
import numpy as np
from MSSCFormer.utilities.one_hot_encoding import to_one_hot
import shutil

matplotlib.use("agg")


class MSSCFormerTrainerCascadeFullRes(MSSCFormerTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="MSSCFormerTrainer", fp16=False):
        super(MSSCFormerTrainerCascadeFullRes, self).__init__(plans_file, fold, output_folder, dataset_directory,
    ...
    def do_split(self):
        super(MSSCFormerTrainerCascadeFullRes, self).do_split()
    ...
    def process_plans(self, plans):
        super(MSSCFormerTrainerCascadeFullRes, self).process_plans(plans)
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True,
        ...
        if run_postprocessing_on_folds:
            # in the old MSSCFormer we would stop here. Now we add a postprocessing. This postprocessing can remove everything
