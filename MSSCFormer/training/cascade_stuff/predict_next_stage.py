...
import argparse
from MSSCFormer.preprocessing.preprocessing import resample_data_or_seg
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_python_class([join(MSSCFormer.__path__[0], "training", "network_training")],
                                                trainerclass,
                                                "MSSCFormer.training.network_training")
