...
from MSSCFormer.network_architecture.dynunet_block import get_conv_layer, OutBlock, ResBlock
    ...
    def __init__(
        ...
        if conv_decoder == True:
            ...
            for j in range(depth):
                stage_blocks.append(SC_TransformerBlock(input_size=out_size, hidden_size=out_channels, proj_size=proj_size,
                                                     num_heads=num_heads,
