...
def main():
    ...
    if network == "3d_cascade_fullres":
        assert issubclass(trainer_class, MSSCFormerTrainerCascadeFullRes), "If running 3d_cascade_fullres then your " \
                                                                       "trainer class must be derived from " \
                                                                       "MSSCFormerTrainerCascadeFullRes"
    else:
        assert issubclass(trainer_class, MSSCFormerTrainer), "network_trainer was found but is not derived from " \
                                                         "MSSCFormerTrainer"
