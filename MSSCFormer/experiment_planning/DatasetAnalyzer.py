...
from MSSCFormer.paths import MSSCFormer_raw_data, MSSCFormer_cropped_data
import numpy as np
import pickle
from MSSCFormer.preprocessing.cropping import get_patient_identifiers_from_cropped_files
...
class DatasetAnalyzer(object):
    def __init__(self, folder_with_cropped_data, overwrite=True, num_processes=default_num_threads):
        ...
        print("hello"+self.folder_with_cropped_data)
    ...
    def get_sizes_and_spacings_after_cropping(self):
        sizes = []
        spacings = []
        print(self.patient_identifiers)
