...
if __name__ == "__main__":
    ...
    overwrite_plans = {
        'MSSCFormerTrainerV2_2': ["MSSCFormerPlans", "MSSCFormerPlans_customClip"], # r
        'MSSCFormerTrainerV2_2_noMirror': ["MSSCFormerPlans", "MSSCFormerPlans_customClip"],  # r
        'MSSCFormerTrainerV2_lessMomentum_noMirror': ["MSSCFormerPlans", "MSSCFormerPlans_customClip"],  # r
        'MSSCFormerTrainerV2_2_structSeg_noMirror': ["MSSCFormerPlans", "MSSCFormerPlans_customClip"],  # r
        'MSSCFormerTrainerV2_2_structSeg': ["MSSCFormerPlans", "MSSCFormerPlans_customClip"],  # r
        'MSSCFormerTrainerV2_lessMomentum_noMirror_structSeg': ["MSSCFormerPlans", "MSSCFormerPlans_customClip"],  # r
        'MSSCFormerTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder': ["MSSCFormerPlans", "MSSCFormerPlans_customClip"],  # r
        'MSSCFormerTrainerV2_FabiansResUNet_structSet_NoMirror': ["MSSCFormerPlans", "MSSCFormerPlans_customClip"],  # r
        'MSSCFormerTrainerV2_FabiansResUNet_structSet': ["MSSCFormerPlans", "MSSCFormerPlans_customClip"],  # r

    }

    trainers = ['MSSCFormerTrainer'] + [
        'MSSCFormerTrainerV2_2',
        'MSSCFormerTrainerV2_lessMomentum_noMirror',
        'MSSCFormerTrainerV2_2_noMirror',
        'MSSCFormerTrainerV2_2_structSeg_noMirror',
        'MSSCFormerTrainerV2_2_structSeg',
        'MSSCFormerTrainerV2_lessMomentum_noMirror_structSeg',
        'MSSCFormerTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder',
        'MSSCFormerTrainerV2_FabiansResUNet_structSet_NoMirror',
        'MSSCFormerTrainerV2_FabiansResUNet_structSet',
    ]
