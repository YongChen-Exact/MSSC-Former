...
if __name__ == "__main__":
    ...
    plans = "MSSCFormerPlansv2.1"

    overwrite_plans = {
        'MSSCFormerTrainerCascadeFullRes': ['MSSCFormerPlans'],
    }

    trainers = [
        'MSSCFormerTrainerCascadeFullRes',
        'MSSCFormerTrainerV2CascadeFullRes_EducatedGuess',
        'MSSCFormerTrainerV2CascadeFullRes_EducatedGuess2',
        'MSSCFormerTrainerV2CascadeFullRes_EducatedGuess3',
        'MSSCFormerTrainerV2CascadeFullRes_lowerLR',
        'MSSCFormerTrainerV2CascadeFullRes',
        'MSSCFormerTrainerV2CascadeFullRes_noConnComp',
        'MSSCFormerTrainerV2CascadeFullRes_shorter_lowerLR',
        'MSSCFormerTrainerV2CascadeFullRes_shorter',
        'MSSCFormerTrainerV2CascadeFullRes_smallerBinStrel',
        #'',
        #'',
        #'',
        #'',
